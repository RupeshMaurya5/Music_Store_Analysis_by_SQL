...
-- Q4: Which city has best customers? We would like to throw a promotional Music Festival in the city we made the 
...
-- Q7: Let's invite the artist who have writtrn the most rock music in our dataset. Write a query that return the 
...
-- Q9: Find how much amount spent by each customer on artists? Write a query to return customer name,artist name and 
-- total spent.
...
-- Q11: Write a query that determines the customer that has spent the most on music for each country. Write a query that 
-- returns the country along with the top customer and how much they spent. For countries where the top amont spent 
